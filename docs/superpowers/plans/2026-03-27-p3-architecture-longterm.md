...
- [ ] **Step 1: 在 services/common 下创建测试目录和 conftest**
...
- [ ] **Step 2: 编写 gateway-service 核心测试**
...
- [ ] **Step 3: 在 dashboard_server.py 启动时调用迁移**
...
- [ ] **Step 1: 提取 PublishQueueCard**

从 `Dashboard.tsx` 中提取 `PublishQueueCard` 为独立文件，用 `React.memo` 包装。

- [ ] **Step 2: 提取 SliderStatsCard**

同上。

- [ ] **Step 3: 提取 XgjControlPanel**

同上。

- [ ] **Step 4: 修改 Dashboard.tsx 使用提取的组件**
