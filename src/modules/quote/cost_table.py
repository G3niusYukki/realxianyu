...
_DATA_DIR = Path(__file__).resolve().parent.parent.parent.parent / "data" / "quote_data"
_COURIER_ALIASES_PATH = _DATA_DIR / "courier_aliases.json"
_REGION_ALIASES_PATH = _DATA_DIR / "region_aliases.json"
...
COURIER_ALIASES = _load_json(_COURIER_ALIASES_PATH)
...
REGION_ALIASES = _load_json(_REGION_ALIASES_PATH)
